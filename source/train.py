...
def parse_args():
    ...
    # Checkpointing
    parser.add_argument("--exp-name", type=str, default="formation", help="name of the experiment")
    parser.add_argument("--save-dir", type=str, default="/mnt/c/Users", help="directory in which training state and model should be saved")
    ...
    parser.add_argument("--benchmark-iters", type=int, default=5, help="number of iterations run for benchmarking")
    parser.add_argument("--benchmark-dir", type=str, default="", help="directory where benchmark data is saved")
